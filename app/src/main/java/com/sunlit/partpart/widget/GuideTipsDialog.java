...
package com.sunlit.partpart.widget;
...
import com.sunlit.partpart.core.http.api.ApiService;
import com.sunlit.partpart.core.http.callback.NoTipCallBack;
import com.sunlit.partpart.core.http.entity.TipInfo;
import com.sunlit.partpart.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.sunlit.partpart.widget.key_is_ignore_tips_";
